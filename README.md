...
Drag the empty area of the title bar to move. Press `×` to **hide to the tray** (keisen keeps running).

- **Tray left-click:** toggle the palette show/hide
...
ウィンドウ上部の余白をドラッグすると移動できます。`×` は**トレイへ隠す**だけで、プロセスは残ります。

- **トレイ左クリック:** パレットの表示 / 非表示
- **トレイ右クリック:** 表示 / 隠す / **終了**
...
- [eframe / egui](https://github.com/emilk/egui) — UI
- [tray-icon](https://github.com/tauri-apps/tray-icon) — タスクトレイ
